...
## Project Structure
    ...
    ├── anti_social_lounge_30475  # Django project configurations
...
1. Clone this repo and `cd anti_social_lounge_30475`
...
2. Clone this repo and `cd anti_social_lounge_30475`
